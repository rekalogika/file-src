...
/**
 * Copied from Symfony\Component\Validator\Constraints\ImageValidator because
 * the corresponding Image class was made final in upstream
 */
final class ImageValidator extends FileValidator
{
    ...
    public function validate(mixed $value, Constraint $constraint): void
    {
        ...
        $size = @getimagesize((string) $value);
